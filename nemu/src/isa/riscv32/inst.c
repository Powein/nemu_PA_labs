...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  // load one byte
  // INSTPAT("?????? ?????? ????? 000 ????? 00000 11", lb     , I, panic("slti not implemented"));
  // INSTPAT("?????? ?????? ????? 001 ????? 00000 11", lh     , I, panic("slti not implemented"));
  // // 1 word is equals to 4 bytes
  // INSTPAT("?????? ?????? ????? 010 ????? 00000 11", lw     , I, panic("slti not implemented"));
  // INSTPAT("?????? ?????? ????? 100 ????? 00000 11", lbu    , I, panic("slti not implemented"));

  // INSTPAT("?????? ?????? ????? 101 ????? 00000 11", lhu    , I, panic("not implemented"));
  // INSTPAT("?????? ?????? ????? 000 ????? 11001 11", jalr   , I, panic("not implemented"));
  // INSTPAT("000000 000000 00000 000 00000 11100 11", ecall  , I, panic("not implemented"));
  // INSTPAT("000000 000001 00000 000 00000 11100 11", ebreak , I, panic("not implemented"));
  // INSTPAT("", jal,  );
  // INSTPAT("", li,  );
  // INSTPAT("", ret,  );
  // INSTPAT("", sw,  );
